...
// linha 18 e 21 em 'text-sm/5' está definindo o font-size e o line-height ao mesmo tempo
// linha 26 à 28 está fazendo barra de porcentagem, em 'w-4/5' é o quanto tem q preecher do total

export function UsedSpaceWidget() {
  return (
    <div className="mt-auto flex flex-col gap-6">
      <nav className="space-y-0.5">
        <NavItem icon={FiLifeBuoy} title="Support" />
        <NavItem icon={BiCog} title="Dashboard" />
      </nav>
      ...
      <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
        ...
        <div className="h-2 rounded-full bg-violet-100 dark:bg-zinc-600">
          <div className="h-2 w-4/5 rounded-full bg-violet-500 dark:bg-violet-400"></div>
        </div>
